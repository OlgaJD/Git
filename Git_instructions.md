...
**git checkout commit** - переход к необходимой версии. Где commit - это имя необходимого коммита или первые 4 символа необходимого коммита.
...
**git diff com1 com2** -показывает разницу между двумя сравниваемыми коммитами, где com1 и com2 можно указать полное имя коммита или первые 4 символа.
